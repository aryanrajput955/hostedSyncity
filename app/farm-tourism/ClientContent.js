...
import { Star, Leaf, Sun, Wind, Coffee, Heart, Mountain } from "lucide-react";
...
export default function FarmTourismContent() {
                        ...
                        <div className={`order-2 lg:order-1 transition-all duration-1000 ${isVisible['wellness'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {[
                                    ...
                                    { title: 'Meditation', desc: 'MINDFULNESS', icon: Wind },
