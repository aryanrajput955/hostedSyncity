...
import { Phone, Mail, MapPin, Clock, ChevronDown, Send, Check } from "lucide-react";
              ...
              <div className="bg-white p-8 md:p-12 shadow-sm border-t-4 border-primary">
                ...
                <form className="space-y-8">
                  <div className="grid md:grid-cols-2 gap-8">
                    <GuestbookInput label="First Name" id="firstName" />
                    <GuestbookInput label="Last Name" id="lastName" />
                  </div>

                  <div className="grid md:grid-cols-2 gap-8">
                    <GuestbookInput label="Email Address" id="email" type="email" />
                    <GuestbookInput label="Phone Number" id="phone" type="tel" />
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <textarea
                      id="message"
                      rows={4}
                      className="w-full bg-transparent border-b border-neutral-200 py-2 focus:outline-none focus:border-primary transition-colors text-neutral-600 resize-none placeholder:text-neutral-300 placeholder:italic"
                      placeholder="Share your thoughts, dates, or questions..."
                    />
                  </div>

                  <div className="pt-6">
                    <button className="group relative w-full md:w-auto overflow-hidden bg-primary text-white px-10 py-4 shadow-lg transition-transform hover:-translate-y-1">
...
// Sub-components
function GuestbookInput({ label, id, type = "text" }) {
  return (
    <div className="relative group">
      <input
        ...
        id={id}
        placeholder=" "
        className="peer w-full bg-transparent border-b border-neutral-200 py-3 focus:outline-none focus:border-primary transition-colors text-neutral-800"
      />
      <label
        htmlFor={id}
        className="absolute left-0 top-3 text-neutral-500 transition-all duration-300 pointer-events-none 
                       peer-focus:-top-4 peer-focus:text-xs peer-focus:text-primary peer-focus:font-bold
                       peer-not-placeholder-shown:-top-4 peer-not-placeholder-shown:text-xs peer-not-placeholder-shown:text-primary peer-not-placeholder-shown:font-bold"
      >
        {label}
      </label>
    </div>
